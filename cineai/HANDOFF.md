...
**Target deploy:** OVH cloud server (`REDACTED-ORIGIN-IP`) + Cloudflare in front  
...
- **DNS:** A record → `REDACTED-ORIGIN-IP`, orange cloud (proxied) ✓
- **Minimum TLS:** 1.2
...
The app is running live on `REDACTED-ORIGIN-IP`:
